<?php function xnews_footer_1() {?>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 footer-about">
              <h2><?php echo esc_html__('About Us', 'xnews'); ?></h2>
              <p><?php echo html_entity_decode(get_theme_mod('xnews_footer_about_us', 'Donec eu tellus convallis, vehicula neque sed, mattis elit. Praesent ornare, ligula in efficitur egestas, massa lacus vulputate enim')); ?> </p>
              <p><?php echo esc_html__('Contact us:', 'xnews'); ?> <a class="mail" href="mailto:<?php echo esc_html(get_theme_mod('xnews_footer_about_us_mail', 'info@xnews.com')); ?>" target="_top"><?php echo esc_html(get_theme_mod('xnews_footer_about_us_mail', 'info@xnews.com')); ?></a></p>
            </div>
            <div class="col-md-5 footer-social">
              <h2><?php echo esc_html__('Follow Us', 'xnews'); ?></h2>
              <?php xnews_socials(); ?>
              <p><?php echo html_entity_decode(get_theme_mod('xnews_footer_follow_us', 'Donec eu tellus convallis, vehicula neque sed')); ?></p>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 footer-copyright">
              <p><?php echo html_entity_decode(get_theme_mod('xnews_copyright_text', 'Copyright 2017. Powered by WordPress Theme. By Madars Bitenieks')); ?></p>
            </div>
              <div class="col-md-6">
  ...
  <?php } ?>
  <?php
} add_filter('xnews_footer_1','xnews_footer_1'); ?>
<?php function xnews_footer_2() {?>
  <?php $option = get_option("xnews_theme_options"); ?>
  <?php if  (!empty($option['footer_top'])) {  ?>
    <?php if  ($option['footer_top'] == '1') {  ?>
      <div class="footer-top">
  ...
  <?php } ?>
  <?php
} add_filter('xnews_footer_2','xnews_footer_2');
function xnews_footer_3() {?>
  <?php $option = get_option("xnews_theme_options"); ?>
  <?php if  (!empty($option['footer_top'])) {  ?>
    <?php if  ($option['footer_top'] == '1') {  ?>
      <div class="footer-top">
  ...
  <?php } ?>
  <?php
} add_filter('xnews_footer_3','xnews_footer_3'); ?>
